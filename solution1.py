...
#fig = tools.make_subplots(rows=21, cols=1, shared_xaxes=True, shared_yaxes=True,
...
#fig['layout'].update(height=1500, width=600, title='Stacked subplots')
